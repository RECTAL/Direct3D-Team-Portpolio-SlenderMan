...
class CWindow;
class CSpriteObject_ListSquare :public CSpriteObject
{
public:
	CSpriteObject_ListSquare(std::string a_stSpriteTexturePath, std::string a_stExtantion, const float width, const float height, int a_nAnimationFrame);
	virtual ~CSpriteObject_ListSquare();
public:			//interface
