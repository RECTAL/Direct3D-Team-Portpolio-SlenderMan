...
class CWindowScrollBar :public CWindow
{
public:
	CWindowScrollBar(std::string a_stWindowName, CWindowType a_ECWindowType, SIZE a_stActiveSize, D3DXVECTOR3 a_stAbsolutePos);
	virtual ~CWindowScrollBar();
